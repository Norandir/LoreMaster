//@ts-nocheck
import { StyleSheet, Text, TouchableOpacity, View,StatusBar,SafeAreaView,ScrollView, FlatList, Button ,Switch} from "react-native";
...
const [DwarfText, setDwarfText] = useState(' # Dwarf');
